...
import ClientOnly from '@/components/ClientOnly' // Make sure to import the ClientOnly component
        ...
        <ClientOnly>
            <div className="p-8 space-y-8 bg-gray-100 min-h-screen">
                ...
                <Suspense fallback={<div>Loading...</div>}>
                    <TripsContent setTrips={setTrips} trips={trips} />
                </Suspense>
            </div>
        </ClientOnly>
    )
...
const TripsContent: React.FC<{ setTrips: React.Dispatch<React.SetStateAction<TripType[]>>, trips: TripType[] }> = ({ setTrips, trips }) => {
